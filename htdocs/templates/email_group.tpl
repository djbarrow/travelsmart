...
<body>
{LOGOS}
<form action="email_group.php" method=POST>
<table align=center>
<tr align=center>
<td colspan=2>
<h2>Email group</h2>
...
<tr>
<td colspan=2>
You can enter multiple email addresses just seperate them by commas or newlines.</td>
</tr>
<tr>
<td>To :</td>
<td>
<textarea name="to" rows=5 cols=80 wrap=virtual>
{TO}
</textarea>
</td>
</tr>
